...
local function lsp_keymaps(bufnr)
  ...
  --vim.api.nvim_buf_set_keymap(bufnr, "n", "gr", "<cmd>Telescope lsp_references theme=cursor layout_config={width=0.9}<CR>", opts)
  --vim.api.nvim_buf_set_keymap(bufnr, "n", "gr", "<cmd>Telescope lsp_references theme=dropdown layout_config={width=0.5}<CR>", opts)
